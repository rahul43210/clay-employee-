...
public class PackageInformationCouponAdapter extends BaseAdapter {
	Context context;
    List<PackageInformationCouponPojo> rowItems;
    Activity activity;
    public PackageInformationCouponAdapter(Context context, List<PackageInformationCouponPojo> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_coupon_details, null);
        ...
        PackageInformationCouponPojo rowItem = (PackageInformationCouponPojo) getItem(position);
