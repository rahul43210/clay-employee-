...
public class OrderPullBackCheckListAdapter extends BaseAdapter {
	Context context;
    List<CheckListPojo> rowItems;
    Activity activity;
    public OrderPullBackCheckListAdapter(Context context, List<CheckListPojo> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.row_pullbackcheck_list, null);
