...
public class PackageInformationPojo {
	public PackageInformationPojo(String items, String call_type,
			String unit_price, String min_price, String off_peak_price,
			String unit, String min_unit) {
		super();
		this.items = items;
	...
	public String items,call_type,unit_price,min_price,off_peak_price,unit,min_unit;
